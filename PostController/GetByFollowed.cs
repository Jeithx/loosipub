...
namespace Api.Controllers.v1.PostController
{
    public partial class PostController
    {
        ...
        [HttpGet("GetByFollowed")]
        public async Task<IActionResult> GetByFollowed(int? pageNumber = 1, int? pageSize = 10)
        {
            ...
            var result = await _service.GetByFollowed(long.Parse(userId), pageNumber, pageSize);
